...
MSG_HASH(
   ...
   "Sets how many milliseconds to sleep before running the core after video presentation. Can reduce latency at the cost of higher risk of stuttering.\nValues 20 and above are treated as frame time percentages."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Minimize input latency and frame drops while obtaining target 'Frame Delay'. Starting point is 3/4 frame time when 'Frame Delay' is 0 (Auto)."
   )
MSG_HASH(
